...
public class TestRunner extends BaseRunner
{
    ...
    public static void runTests(String[] classes, double totalPoints)
    {
        ...
        try (PrintStream out = new PrintStream(baos))
        {
            ...
            {
                String studentName = System.getProperty("STUDENT");
                String assignmentName = System.getProperty("ASSIGNMENT");
                if (studentName == null || assignmentName == null)
                {
                    Class<?> studentClass = getClass(hwPackage + "." + hwClass);
                    Field student = studentClass.getField("STUDENT");
                    studentName = (String)(student.get(null));
                    Field assignment = studentClass.getField("ASSIGNMENT");
                    assignmentName = (String)(assignment.get(null));
                }
//                Class<?> studentClass = getClass(hwPackage + "." + hwClass);
//                Field student = studentClass.getField("STUDENT");
